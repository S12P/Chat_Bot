...
interpreter = RasaNLUInterpreter("models/nlu/default/faqcvecbot/")
MODEL_PATH = "models/dialogue"
action_endpoint = EndpointConfig(url="https://localhost:5005/webhook")

agent = Agent.load(MODEL_PATH, interpreter=interpreter, action_endpoint=action_endpoint) #mon chat bot
...
input_channel = MyNewInput(url='https://localhost')
